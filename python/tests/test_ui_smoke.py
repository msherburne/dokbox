...
from dokbox.models.docker_resources import (
    DockerResourceKind,
    LogLine,
    MetricSample,
    ResourceSummary,
)
from dokbox.main import Dokbox
from dokbox.ui.screens import (
...
from dokbox.view_models.resources import ShortcutHint
