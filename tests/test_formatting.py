...
from view_models.formatting import format_bytes, format_ratio_bar, format_timestamp
...
class FormattingTest(unittest.TestCase):
    ...
    def test_format_ratio_bar_clamps_values(self):
        self.assertEqual(format_ratio_bar(0.0, width=5), "----- 0%")
        self.assertEqual(format_ratio_bar(0.42, width=10), "####------ 42%")
        self.assertEqual(format_ratio_bar(2.0, width=5), "##### 100%")
